...
return (
        ...
        <svg width="30" height="30" fill="none" className="iconsocial" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
